/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d76e3add1efcc25290798807961eb572)
// Runtime types generated with workerd@1.20260825.1 2026-09-17 nodejs_compat
interface __BaseEnv_Env {
	...
	WORKFLOW_NOTIFICATION_EMAILS: "shiyue@18.cn";
	VAPID_SUBJECT: "mailto:shiyue@18.cn";
	LEGACY_WORKFLOW_USER_ID: "auth0|6a9e921870e37d7bbfb76c8f";
	VAPID_PUBLIC_KEY: "BIxrfo5sKvyQVHWaHS7EtLX5FUNd4UbnB8NxgMvwm-AdOANJRLaRsXScR_tcWi5GqXfxQKiqoqIiFCWXMW9vnGo";
	NOTIFICATION_SOURCE: Service /* entrypoint NotificationSource from eastmoney-dashboard */;
	OMO: Workflow /* OmoWorkflow from ingest */;
	OPEN_MARKET: Workflow /* OpenMarketWorkflow from ingest */;
	MARKET_BRIEFING: Workflow /* MarketBriefingWorkflow from eastmoney-dashboard */;
	ARTICLE: Workflow /* ArticleWorkflow from ingest */;
	ARTICLE_CLEANUP: Workflow /* ArchiveCleanupWorkflow from ingest */;
	TELEGRAM: Workflow /* TelegramWorkflow from ingest */;
	POLICY_AGGREGATION: Workflow /* PolicyWorkflow from ingest */;
	BOND_LEDGER_IMPORT: Workflow /* BondLedgerImportWorkflow from eastmoney-dashboard */;
	FINANCING_DEBT_IMPORT: Workflow /* DebtImportWorkflow from eastmoney-dashboard */;
	ECONOMIC_INDICATOR_SYNC: Workflow /* EconomicIndicatorSyncWorkflow from eastmoney-data */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FROM_EMAIL" | "CLOUDFLARE_ACCOUNT_ID" | "WORKFLOW_NOTIFICATION_EMAILS" | "VAPID_SUBJECT" | "LEGACY_WORKFLOW_USER_ID" | "VAPID_PUBLIC_KEY">> {}
}
