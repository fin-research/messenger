/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2909ef7e88074a11bdde7ab5b82a0dfe)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FROM_EMAIL">> {}
}
